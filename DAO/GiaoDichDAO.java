            ...
            return giaoDich;
               ...
               try {
                ...
                while (rs.next()) {
                    ...
                    jsonObject.addProperty("idXe", rs.getInt("id_xe"));
                    jsonObject.addProperty("loaiGiaoDich", rs.getString("loai_giao_dich"));
                    jsonObject.addProperty("ngayGiaoDich", rs.getDate("ngay_giao_dich").toString());
                    jsonObject.addProperty("giaTien", rs.getDouble("gia_tien"));
